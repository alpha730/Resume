...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    lines: ['AI Chatbot for Ocean Data', 'Cricket Score Predictor', 'Feedback System Dashboard'],
    detail: [
      {
  ...
  },
  {
    ...
    title: 'CONTACT',
    subtitle: 'say hello',
    lines: ['aryanraj0828@gmail.com', 'github.com/alpha730', 'linkedin: aryan-kumar'],
    detail: [
      {
        heading: 'REACH ME',
